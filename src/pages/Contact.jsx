...
import animData from "../assets/contact.json";
    ...
    <section className="mx-5 py-10 md:container font-alice md:mx-auto md:py-20">
        ...
        <h1 style={{letterSpacing:"10px"}} className="text-xl md:text-3xl">Votuhot LLC</h1>
          ...
          <div className="flex gap-5">
            <div className="flex h-fit w-fit items-center justify-center rounded-xl bg-[#7049C3] p-4 text-primary shadow">
              <BiHome className="text-xl text-white md:text-2xl" />
            </div>
          ...
          <div className="flex gap-5">
            <div className="flex h-fit w-fit items-center justify-center rounded-xl bg-[#7049C3] p-4 text-primary shadow">
              <BiPhone className="text-xl text-white md:text-2xl" />
            </div>
            <div className="flex flex-col gap-2">
          ...
          <div className="flex gap-5">
            <div className="flex h-fit w-fit items-center justify-center rounded-xl bg-[#7049C3] p-4 text-primary shadow">
              <MdEmail className="text-xl text-white md:text-2xl" />
            </div>
            <div className="flex flex-col gap-2">
      ...
      <div className="mt-10 grid gap-8 md:mt-20 md:gap-16 lg:grid-cols-2">
        ...
        >
          ...
          <button
            type="submit"
            className="group flex items-center justify-center gap-4 rounded border border-primary px-8 py-2 font-semibold text-primary duration-300 ease-linear hover:bg-primary hover:text-black md:w-fit"
          >
            {loader ? (
