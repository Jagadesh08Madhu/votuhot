  ...
  return (
    <section className='font-alice'>
        <div className='flex flex-col py-5 lg:flex-row md:px-10 '>
          {/* Left section */}
          <div className='lg:w-1/2 flex flex-col px-2 gap-5 justify-center order-2 lg:order-1 items-center text-gray-800'>
            <h1 className='text-4xl text-[#2F1C6A] md:text-5xl lg:text-7xl'>Blazing-Fast <span className='text-[#7049c3]'>Hosting</span>, Engineered for Excellence</h1>
            <p className='text-lg tracking-widest'>Experience unmatched speed and reliability with our next-generation hosting solutions. Designed for peak performance, 
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 pt-10 gap-5 lg:gap-10">
                <button style={{ letterSpacing: "5px" }} className="bg-[#2F1C6A] text-white px-6 rounded-lg text-base py-2">
                  Shop Now
                </button>
                <button style={{ letterSpacing: "5px" }} className="bg-[#E2DBFC] text-[#2F1C6A] px-6 rounded-lg text-base py-2">
                  Contact
                </button>
              </div>
          </div>
